  ...
  fluidPage(theme = shinytheme("lumen"),
            navbarPage("Place Matters App",
                       header = use_theme(
                         create_theme(
                           theme = "lumen",
                           bs_vars_global(body_bg = "#FEFCFA",
                                          text_color = "#4E453B"),
                           bs_vars_wells(bg = "#8b000044",
                                         border = "#8b0000"),
                           bs_vars_navbar(
                             default_bg = "#8b0000",
                             ...
                             default_link_active_bg = "#6b0000",
                             default_link_hover_bg = "#6b0000"
                           ),
                           bs_vars_dropdown(
                             link_active_bg = "#EEE",
                             link_hover_bg = "#EEE",
                       ...
                       tabPanel("Analyzing Risk in Philadelphia",
                                sidebarLayout(sidebarPanel(width = 2, selectInput("ZIP1",
                                              ...
                                              mainPanel(plotOutput("plot",
                                                                   ...
                                                                   height = "500px"),
                                                        h4(br(),
                                                           strong("Risk:", style = "color: #8b0000"),"A composite index of measures of poverty, education, unemployment, crime and ACEs",
                                                           br(),
                                                           strong("Poverty:", style = "color: #8b0000"), "Percent of families with children below the poverty level",
                                                           br(),
                                                           strong("Education:", style = "color: #8b0000"), "Percent with less than 9th grade education",
                                                           br(),
                                                           strong("Unemployment:", style = "color: #8b0000"), "Percent unemployed",
                                                           br(),
                                                           strong("Crime:", style = "color: #8b0000"), "Shooting victims per 10,000",
                                                           br(),
                                                           strong("ACEs:", style = "color: #8b0000"), "Percent with at least 1 Adverse Childhood Experience",
                                                           br(),
                                                           br())))),
  ...
  output$plot <- renderPlot({
    ...
    ggplot() +
      ...
      theme(legend.position = "none",
            ...
            panel.grid.major.y = element_line(color = "#00000044"),
            text = element_text(color = "#4E453B", family = "Helvetica", size = 14),
            plot.background = element_rect(fill = "#FEFCFA"),
            panel.background = element_rect(fill = "#FEFCFA")) +
      scale_fill_manual(values = c("#8b0000", "#8b8b8b"))
